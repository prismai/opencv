...
void VideoWriter_create(CvVideoWriter*& writer, Ptr<IVideoWriter>& iwriter, VideoCaptureAPIs api,
        const String& filename, int fourcc, double fps, const Size& frameSize, bool isColor, int bitrate)
{
...
#ifdef HAVE_FFMPEG
    case CAP_FFMPEG:
        CREATE_WRITER(cvCreateVideoWriter_FFMPEG_proxy(filename, fourcc, fps, frameSize, isColor, bitrate));
        break;
#endif
#ifdef HAVE_MSMF
    case CAP_MSMF:
